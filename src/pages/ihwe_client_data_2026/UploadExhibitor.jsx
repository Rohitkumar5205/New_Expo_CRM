        ...
        <div className="w-full bg-white shadow-md rounded-md p-6 m-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center border rounded-md p-5 bg-[#f9fafb]">
            ...
            <div className="flex flex-col gap-2 w-full md:w-3/4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-1.5 bg-[#337ab7] hover:bg-[#286090] text-white text-sm font-medium  transition-colors duration-200"
                >
                  Import
                </button>
              </div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-[#a58d6f] hover:bg-[#8b745d] text-white px-6 py-3  mt-4 md:mt-0 transition-colors duration-200"
            >
              <FaFileExcel size={26} />
