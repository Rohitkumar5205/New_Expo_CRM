...
const HealthCampOverview = () => {
  ...
  useEffect(() => {
    if (!healthCampVisitors || healthCampVisitors.length === 0) {
  ...
  // ✅ FIXED: window.confirm use kiya, showSuccess ka galat use hataya
  ...
  const hasReviews = visitorReviews && visitorReviews?.length > 0;
                    ...
                    <div className="flex-grow">
                      <p className="font-medium text-xs sm:text-sm">
                        ...
                        <span
                          ...
                          className={`${index === 0 ? "text-red-500 cursor-pointer hover:underline" : "text-gray-700"} uppercase`}
                        >
                          {" "}
                          | ▲ Added on{" "}
                          {review.added
